              ...
              >
                ...
                >
                  ...
                  <div className="absolute w-full h-full glass-card rounded-xl p-8 flex flex-col items-center justify-center text-center backface-hidden border-t-4 border-primary">
                    <div className="bg-primary/10 p-4 rounded-full mb-6 transition-transform md:group-hover:scale-110">
                    ...
                    <p className="text-muted-foreground mt-2 font-tech text-sm hidden md:block">
                      Hover to reveal
                    </p>
                    <p className="text-muted-foreground mt-2 font-tech text-sm md:hidden">
                      Tap to reveal
                    </p>
                  </div>
